...
<img class="carro" src="http://localhost/feetshoesshop/imagens/carro.png" />
 ...
 <div class="d2">
  ...
  <?php
    ...
    echo $busca;
    $sql="SELECT ID_PRO, NOME_PRO, PRECO_PRO, DESCRICAO FROM tb_produto WHERE ID_PROD LIKE '%".$busca."%' OR NOME_PRO LIKE '%".$busca."%' OR DESCRICAO LIKE '%".$busca."%' AND ID_PUBLICO=1 ORDER BY ID_PROD";
